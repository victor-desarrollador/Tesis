module.exports = [
"[project]/src/lib/wishlistApi.ts [app-ssr] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/src_lib_wishlistApi_ts_ed87faea._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/src/lib/wishlistApi.ts [app-ssr] (ecmascript)");
    });
});
}),
