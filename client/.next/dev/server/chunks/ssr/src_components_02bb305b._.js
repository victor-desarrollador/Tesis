...
const CartPageClient = ()=>{
    ...
    const handleRemoveItem = async (itemId)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Producto eliminado del carrito");
        } catch (error) {
            console.error("Error al eliminar:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("No se pudo eliminar el producto");
        }
    };
    ...
    const handleQuantityChange = async (itemId, newQuantity)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("No se pudo actualizar la cantidad");
        }
    };
    ...
    const confirmClearCart = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Tu carrito ha sido vaciado");
        } catch (error) {
            console.error("Error al vaciar carrito:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("No se pudo vaciar el carrito");
        } finally{
            setIsLoading(false);
        }
    };
    const handleCheckout = async ()=>{
        ...
        try {
            if (!auth_token) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Inicia sesión para finalizar tu compra");
        ...
        // toast.success("Iniciando proceso de pago..."); // Optional, visually noisy if redirect is fast
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Error al iniciar el pago. Intenta nuevamente.");
        } finally{
            setIsCheckingOut(false);
        }
    };
