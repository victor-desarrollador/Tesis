...
const Categories = () => {
    ...
    const handleAddCategory = async (data: FormData) => {
        ...
        try {
            ...
            setPage(1); // Restablecer a la página 1 después de agregar
            fetchCategories();
        } catch (error: unknown) {
            console.log("No se pudo crear la categoría", error);
    ...
    const handleUpdateCategory = async (data: FormData) => {
        ...
        try {
            ...
            console.log("No se pudo actualizar la categoría", error);
    ...
    const handleDeleteCategory = async () => {
        ...
        try {
            ...
            console.log("No se pudo eliminar la categoría", error);
    ...
    const handleRefresh = async () => {
        ...
        try {
            ...
            setTotal(response?.data?.total || 0);
            setTotalPages(response?.data?.totalPages || 1);
            toast("Categorías recargadas exitosamente");
        } catch (error) {
            console.log("No se pudo recargar las categorías", error);
            toast("No se pudo recargar las categorías");
        } finally {
            setRefreshing(false);
        }
    };
                    ...
                    {total > 0 && (
                        <div className="flex items-center justify-between">
                            <div className="text-sm text-muted-foreground">
                                ...
                                {Math.min(page * perPage, total)} of {total} categorías
                            </div>
                    ...
                    <Form {...formAdd}>
                        ...
                        >
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Imagen de la Categoría (Opcional)</FormLabel>
                                        <FormControl>
                                            <ImageUpload
                                                value={field.value ?? ""}
            ...
            <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>Actualizar información de la categoría</DialogDescription>
                    </DialogHeader>
                    <Form {...formEdit}>
                        <form
            ...
            <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Esta acción no puede ser deshecha. Esta categoría será permanentemente eliminada{" "}
