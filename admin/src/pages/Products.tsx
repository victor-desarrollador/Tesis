    ...
    const handleAddProduct = async (data: FormData) => {
        ...
        try {
            ...
            const productData = {
                ...
                // Backend expects images array, frontend form has single image string
                images: data.image ? [{ url: data.image, publicId: "" }] : [],
            };
                ...
                <>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {products.map((product, index) => (
                                        <TableRow
                                            key={product._id}
                                            className={`border-b border-border/30 transition-colors hover:bg-muted/50 ${index % 2 === 0 ? "bg-background" : "bg-muted/20"
                                                }`}
                                        >
                    ...
                    {total > 0 && total <= perPage && (
                        <div className="text-center text-sm text-muted-foreground bg-card rounded-lg border border-border/50 px-4 py-3">
                            Mostrando todos los productos <span className="font-medium">{total}</span>
                        </div>
                    )}
                </>
            )}
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Precio Original (Antes)</FormLabel>
                                            <FormControl>
                                                <Input
                                                    {...field}
                                                    type="number"
